...
export default function SuperAdminRegistrationScreen() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f1218] flex flex-col items-center">
      {/* Header */}
      ...
      <div className="w-full max-w-sm px-6 py-4 flex flex-col pb-20 overflow-y-auto">
