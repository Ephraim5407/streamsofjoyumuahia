              ...
              {options?.map((opt: any) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-3 text-sm text-left rounded-lg transition-all ${isSelected
              ...
              {options.map((opt: string) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => toggle(opt)}
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 text-sm text-left rounded-lg transition-all ${isSelected
                        ? "bg-[#2CA6FF]/10 dark:bg-[#2CA6FF]/20 font-bold text-[#2CA6FF]"
                        : "text-[#344054] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                      }`}
                  >
              ...
              <div>
                ...
                {password && confirm && password !== confirm && (
                  <motion.div
                    ...
                    className="flex items-center gap-2 px-3 py-2.5 mb-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30"
                  >
              ...
              <div>
                ...
                <div className="flex items-start gap-3 mb-8 p-4 bg-blue-50/30 dark:bg-blue-900/10 rounded-2xl border border-blue-100/50 dark:border-blue-900/20">
                  <button
                    ...
                    className={`w-5 h-5 rounded-md border-2 flex items-center justify-center shrink-0 mt-0.5 transition-all ${agree
